...
class PodCollectionAgent:
    def __init__(self, state_shape, action_size):
        ...
        self.policy_net = DQN(self.state_shape[0], action_size).to(self.device)
        self.target_net = DQN(self.state_shape[0], action_size).to(self.device)
